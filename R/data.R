...
#'   \item{transProbs}{Probabilities of transitioning from one state to another.}
#'   \item{emissionProbs}{Given a certain genotype combination, the odds of each possible state.}
#' }
#' @source Created in-house based on basic Mendelian rules for calculating UPD events.
#' @examples data(hmm)
"hmm"
