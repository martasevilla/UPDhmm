...
These filtering steps are now integrated directly inside the collapseEvents() function, so users no longer need to filter events manually before collapsing.
