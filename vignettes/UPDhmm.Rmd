...
- n_mendelian_error (default = 2): number of Mendelian Errors found in the UPD event.

- size (default = 500,000): minimum length of the event to be considered.

Second, `collapseEvents()` combines UPD events with the same type and reported in the same chromosome as a single event. Thus, we obtain a list of UPD events for individual and chromosome: 
