...
<<<<<<< HEAD
difference on the genotype alelle frequencies obtained with the different 
...
genotype sequence,using the Viterbi algorithm All in all, `UPDhmm` infers 
=======
...
<<<<<<< HEAD
This function requires the object generated by the `vcfCheck()` function.
