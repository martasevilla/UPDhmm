...
"The UPDhmm package utilizes a Hidden Markov Model (HMM) to identify regions 
indicative of Uniparental Disomy (UPD) events, employing genetic data from a 
trio (mother, father, and proband). The HMM is constructed based on how the 
probabilities of all possible genotype combinations within the trio differ 
across potential hidden states (isodisomy, heterodisomy, or normal). By 
employing the Viterbi algorithm, the UPDhmm package provides the most optimal 
and probable inheritance pattern for a given genotype sequence. In essence, 
UPDhmm deduces the most probable inheritance pattern for each genomic region, 
facilitating the detection of UPD events in the proband."
